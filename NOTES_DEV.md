...
> **RAPPEL DESIGN** — revenir sur l'outil de design (planche "Refonte CB Bretagne") pour la refonte des écrans restants : éditeur de devis (`devis_detail.html`), écran d'édition facture (`facture_detail.html` — PAS l'aperçu PDF client), planning/émargement. Charte actée : Montserrat, prune #67123A / turquoise #00AA8D / or #F7A600 / rouge danger #C0392B, contraste AA, textes ≥14px, cibles terrain ≥48px. Chrome option 2 : topbar blanc (logo couleur), sidebar prune, page-hd blanc. Relevé : option A retenue (canvas + tiroir), option B (parcours guidé) à tester pour débutants.
