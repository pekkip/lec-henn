...
# PARTIE 2 — Éditeurs (devis & facture)

**Objectif :** réorganiser le **haut** des deux éditeurs pour plus de lisibilité et les rendre **cohérents entre eux**. On ne touche pas à la logique métier : arbre des lignes, calculs, drag-and-drop, sauvegarde serveur, bibliothèque, aides/financements, progression par titre, acomptes — tout ça est conservé tel quel. Ce sont des changements de **structure et de présentation** du gabarit autour de l'éditeur.
