...
urlpatterns = [
    ...
    path('devis/import/parse-un/', views.import_devis_parse_one, name='import-devis-parse-one'),
    path('devis/import/confirmer/', views.import_devis_confirm, name='import-devis-confirm'),
    path('devis/import-xls/', views.import_devis_xls_view, name='import-devis-xls'),
    path('devis/import-xls/parse-un/', views.import_devis_xls_parse_one, name='import-devis-xls-parse-one'),
    path('devis/import-xls/confirmer/', views.import_devis_xls_confirm, name='import-devis-xls-confirm'),
    ...
    path('insertion/releve/',                 views_planning.releve_view,           name='releve'),
    path('insertion/releve/import/',          views_planning.releve_import,         name='releve-import'),
